...
const englishCopy = {
  ...
  runtimeFailureReasonCopy: {
    ...
    "rate-limited": "The provider endpoint is rate-limited. Check back and try again in a while; the runtime did not report a retry time.",
...
const simplifiedChineseCopy = {
  ...
  runtimeFailureReasonCopy: {
    ...
    "rate-limited": "该端点正被限流。请稍等片刻再试；运行时未提供可解析的重试时间。",
