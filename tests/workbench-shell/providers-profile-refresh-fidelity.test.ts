...
test("Providers Re-check all follows the pure refresh gate and the one existing catalog bridge read", async () => {
  ...
  try {
    ...
    assert.deepEqual(unavailableCards.map(plainText), [
      "Codex Codex desktop Catalog unavailable Status Runtime not located Catalog Unavailable No lookup path is exposed. Subscription sign-in Unknown Subscription sign-in could not be verified. Re-check before taking an authentication action. Re-check",
      "Claude Claude Code desktop Catalog unavailable Status Runtime not located Catalog Unavailable No lookup path is exposed. Subscription sign-in Unknown Subscription sign-in could not be verified. Re-check before taking an authentication action. Re-check",
    ]);
